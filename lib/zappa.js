...
(function() {
  ...
  zappa.app = function(func, options) {
    var app, apply_helpers, client, client_bundle_simple, client_bundled, context, helpers, io, partials, postrenders, real_root, request_socket, root, route, socket_session, verb, ws_handlers, zappa_prefix, zappa_used, _fn, _i, _len, _ref2;
    if (options == null) {
      options = {};
    }
    context = {
    ...
    context.use = function() {
      var a, k, use, v, zappa_middleware, _j, _len1;
      zappa_middleware = {
